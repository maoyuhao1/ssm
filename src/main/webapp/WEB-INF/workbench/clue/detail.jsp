...
<body>
					...
					<div class="btn-group" style="position: relative; top: 18%; left: 8px;">
						<form class="form-inline" role="form">
						  <div class="form-group has-feedback">
						    <input type="text" class="form-control" style="width: 300px;" placeholder="请输入市场活动名称，支持模糊查询" id="activityQueryLike">
	...
	<div>
		<div style="position: relative; top: 60px; left: 40px;">
			...
			<div>
				<a href="javascript:void(0);" id="relationActivityBtn" data-toggle="modal"  style="text-decoration: none;"><span class="glyphicon glyphicon-plus"></span>关联市场活动</a>
			</div>
		</div>
	</div>
...
<script>
	...
	function queryActivityExculdeNow(){
		$.ajax({
			url : '/crm/workbench/clue/queryActivityExculdeNow',
			data : {
				'clueId' :'${clue.id}',
				'activityName' : $('#activityQueryLike').val()
			},
			type : 'get',
			dataType : 'json',
	...
	$('#relationActivityBtn').click(function () {
		...
		queryActivityExculdeNow();
	})

	queryClueActivity();

	function queryClueActivity() {
		$.ajax({
